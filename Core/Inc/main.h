...
#define BLINKLED_Pin LL_GPIO_PIN_5
...
#define ButtonEnter_Pin LL_GPIO_PIN_4
#define ButtonEnter_GPIO_Port GPIOB
#define ButtonUp_Pin LL_GPIO_PIN_5
#define ButtonUp_GPIO_Port GPIOB
