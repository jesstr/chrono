...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_SetPinPull(ButtonDown_GPIO_Port, ButtonDown_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinPull(ButtonEnter_GPIO_Port, ButtonEnter_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinPull(ButtonUp_GPIO_Port, ButtonUp_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinMode(B1_GPIO_Port, B1_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(ButtonDown_GPIO_Port, ButtonDown_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(ButtonEnter_GPIO_Port, ButtonEnter_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(ButtonUp_GPIO_Port, ButtonUp_Pin, LL_GPIO_MODE_INPUT);
  ...
  /**/
  GPIO_InitStruct.Pin = SLEEP_STATE_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(SLEEP_STATE_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(BLINKLED_GPIO_Port, &GPIO_InitStruct);
